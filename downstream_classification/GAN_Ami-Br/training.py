...
# Setup logging
log_file = f"AMI-Br_Synthetic_Train_Set_img_amibr_mask_amibr_gan_amibr.log"
logging.basicConfig(
    level=logging.INFO,
...
images, labels = load_data_from_folder(
    '/home/MICCAI25/AMI-Br_Synthetic_Train_Set_img_amibr_mask_amibr_gan_amibr', 
    classes
)
...
for fold, (train_idx, val_idx) in enumerate(kf.split(images, labels)):
    ...
    best_model_path = f'AMI-Br_Synthetic_Train_Set_img_amibr_mask_amibr_gan_amibr_fold{fold + 1}_best.pth'
