...
# Setup logging
log_file = f"diffusion_amibr_img_amibr_mask_amibr_diffusion_amibr.log"
logging.basicConfig(
    level=logging.INFO,
...
images, labels = load_data_from_folder(
    '/home/MICCAI25/Amibr_diffusion_synthetic_train_set/AmiBrmodel_AmiBrdataset', 
    classes
)
...
for fold, (train_idx, val_idx) in enumerate(kf.split(images, labels)):
    ...
    best_model_path = f'diffusion_amibr_img_amibr_mask_amibr_diffusion_amibr_fold{fold + 1}_best.pth'
