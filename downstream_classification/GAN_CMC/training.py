...
# Setup logging
log_file = f"AMI-Br_Synthetic_Train_Set_img_CMC_mask_amibr_gan_cmc.log"
logging.basicConfig(
    level=logging.INFO,
...
images, labels = load_data_from_folder(
    '/home/MICCAI25/AMI-Br_Synthetic_Train_Set_img_CMC_mask_amibr_gan_cmc', 
    classes
)
...
for fold, (train_idx, val_idx) in enumerate(kf.split(images, labels)):
    ...
    best_model_path = f'AMI-Br_Synthetic_Train_Set_img_CMC_mask_amibr_gan_cmc_fold{fold + 1}_best.pth'
