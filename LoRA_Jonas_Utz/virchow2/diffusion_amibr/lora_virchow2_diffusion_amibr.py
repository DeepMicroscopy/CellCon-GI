...
# Logging setup
log_file = "virchow2_lora_diffusion_amibr_training.log"
logging.basicConfig(
    level=logging.INFO,
...
# Data
root_data_dir = '/data/MELBA-AmiBr/TriCon-GI/downstream_classification/Amibr_diffusion_synthetic_train_set/AmiBrmodel_AmiBrdataset'
...
for fold, (train_idx, val_idx) in enumerate(skf.split(images, labels)):
    ...
    best_val_acc = 0.0
    best_model_path = f'virchow2_lora_diffusion_amibr_fold_{fold + 1}_best.pth'
    epochs_no_improve = 0
